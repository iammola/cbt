              ...
              return (
                <div
                  ...
                  className={classNames(
                    "flex flex-col justify-start items-end w-full border-t border-white/10 pt-1.5 pr-1 overflow-hidden",
                    {
                ...
                >
                  <span
                    className={classNames(
                      "flex items-center justify-center w-8 h-8 shrink-0 -mt-1 -mr-0.5 text-center rounded-full",
                      {
                        "bg-red-500 text-gray-800 font-semibold text-sm":
                          i === datesObj.today,
                      }
                    )}
                  >

...
const Home: FunctionComponent = () => {
    ...
    const { data: subjectsItems } = useSWR<RouteData<TeacherSubjectsExtendGETData>>(account !== undefined ? `/api/teachers/${account._id}/subjects/extend` : null, url => fetch(url ?? '').then(res => res.json()));

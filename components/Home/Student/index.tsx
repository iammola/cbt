          ...
          {["Exams", "Results"].map((label) => (
            <div
              ...
              className={classNames(
                "group flex items-center relative px-2 pb-3 gap-3.5 cursor-pointer after:absolute after:w-full after:h-0.5 after:left-0 after:-bottom-0.5 after:transition-all hover:after:bg-gray-500",
                {
            ...
            >
              <span
                className={classNames(
                  "font-semibold w-max group-hover:text-gray-800 transition-all",
                  {

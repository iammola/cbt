        ...
        >
          <ul className="flex flex-col items-start justify-center gap-3">
            <li className="flex gap-3 items-center justify-start text-xs text-gray-500 font-medium p-3 w-full rounded-md cursor-pointer hover:bg-gray-50">
              <span className="w-max inline-block">Profile settings</span>
              <Badges.Soon />
            </li>
            <li className="flex gap-3 items-center justify-start text-xs text-gray-500 font-medium p-3 w-full rounded-md cursor-pointer hover:bg-gray-50">
              <span className="w-max inline-block">View profile</span>
              <Badges.Soon />
            </li>
            ...
            <li className="flex gap-3 items-center justify-start text-xs font-medium p-3 w-full rounded-md cursor-pointer hover:bg-gray-50">
              ...
              <span className="w-max inline-block">View students</span>
              <Badges.Soon />
            </li>
            <li className="flex gap-3 items-center justify-start text-xs font-medium p-3 w-full rounded-md cursor-pointer hover:bg-gray-50">
              <BellIcon className="w-5 h-5 text-gray-500" />
              <span className="w-max inline-block">Notifications</span>
              <Badges.Soon />
            </li>
            <li className="flex gap-3 items-center justify-start text-xs font-medium p-3 w-full rounded-md cursor-pointer hover:bg-gray-50">
              <CommentTextIcon className="w-5 h-5 text-gray-500" />
              <span className="w-max inline-block">Messages</span>
              <Badges.Soon />
            </li>
            <Divide className="w-full p-2" />
            <li
            ...
            >
              <span className="w-max inline-block">Log out</span>
            </li>
          </ul>
        </Transition>
      </div>

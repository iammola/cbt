        ...
        <MenuItem>
          <MenuItem.Main>
            <Link href="/home">
              <a
                className={classNames(
                  "flex gap-2.5 items-center w-full rounded-lg text-gray-600 hover:text-gray-800 hover:bg-gray-100 cursor-pointer py-2.5",
                  {
            ...
            <>
              <MenuItem.Main>
                ...
                >
                  ...
                  <ChevronDownIcon
                    className={classNames(
                      "shrink-0 w-5 h-5 ml-auto text-gray-600",
                      {
                        hidden: open === false,
                      }
                    )}
